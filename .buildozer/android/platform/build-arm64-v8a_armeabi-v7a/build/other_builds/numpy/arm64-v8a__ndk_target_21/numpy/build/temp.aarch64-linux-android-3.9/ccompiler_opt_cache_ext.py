...
{'cache_infile': True,
 ...
 'feature_min': {'ASIMD', 'NEON_VFPV4', 'NEON_FP16', 'NEON'},
 ...
 'sources_status': {'build/src.aarch64-linux-android-3.9/numpy/core/src/_simd/_simd.dispatch.c': (True,
                                                                                                  []),
                    'build/src.aarch64-linux-android-3.9/numpy/core/src/umath/loops_arithm_fp.dispatch.c': (True,
                                                                                                            []),
                    'build/src.aarch64-linux-android-3.9/numpy/core/src/umath/loops_arithmetic.dispatch.c': (True,
                                                                                                             []),
                    'build/src.aarch64-linux-android-3.9/numpy/core/src/umath/loops_exponent_log.dispatch.c': (True,
                                                                                                               []),
                    'build/src.aarch64-linux-android-3.9/numpy/core/src/umath/loops_trigonometric.dispatch.c': (True,
                                                                                                                []),
                    'build/src.aarch64-linux-android-3.9/numpy/core/src/umath/loops_umath_fp.dispatch.c': (True,
                                                                                                           []),
                    'build/src.aarch64-linux-android-3.9/numpy/core/src/umath/loops_unary_fp.dispatch.c': (True,
                                                                                                           []),
