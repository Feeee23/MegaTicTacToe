...
{'cache_infile': True,
 ...
 'sources_status': {'build/src.arm-linux-androideabi-3.9/numpy/core/src/_simd/_simd.dispatch.c': (True,
                                                                                                  ['NEON']),
                    'build/src.arm-linux-androideabi-3.9/numpy/core/src/umath/loops_arithm_fp.dispatch.c': (True,
                                                                                                            []),
                    'build/src.arm-linux-androideabi-3.9/numpy/core/src/umath/loops_arithmetic.dispatch.c': (True,
                                                                                                             ['NEON']),
                    'build/src.arm-linux-androideabi-3.9/numpy/core/src/umath/loops_exponent_log.dispatch.c': (True,
                                                                                                               []),
                    'build/src.arm-linux-androideabi-3.9/numpy/core/src/umath/loops_trigonometric.dispatch.c': (True,
                                                                                                                []),
                    'build/src.arm-linux-androideabi-3.9/numpy/core/src/umath/loops_umath_fp.dispatch.c': (True,
                                                                                                           []),
                    'build/src.arm-linux-androideabi-3.9/numpy/core/src/umath/loops_unary_fp.dispatch.c': (True,
                                                                                                           ['NEON']),
