...
class MainSite(FloatLayout):
    ...
    def setGreen(self,Board):
        self.remove_widget(self.gr0)
        self.remove_widget(self.gr1)
        self.remove_widget(self.gr2)
        self.remove_widget(self.gr3)
        self.remove_widget(self.gr4)
        self.remove_widget(self.gr5)
        self.remove_widget(self.gr6)
        self.remove_widget(self.gr7)
        self.remove_widget(self.gr8)
...
class Spieloberfl(App):
    ...
    #Window.size = (1080,2273) #my Phone
    print('Find')
